...
def run(ifc_file):
    ...
    for element in elements:
        _data = {
            ...
            "totalHeight": area_helper.extract_value(element, "Abhängigkeiten", "Nicht verknüpfte Höhe"),
            ...
            "type": element.is_a(),
            "type_identifier": element.IsTypedBy[0].RelatingType.GlobalId if element.IsTypedBy and len(element.IsTypedBy) > 0 else element.is_a(),
            "type_name": element.IsTypedBy[0].RelatingType.Name if element.IsTypedBy and len(element.IsTypedBy) > 0 else element.is_a(),
